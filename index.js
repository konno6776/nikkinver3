...
app.get("/",(req,res)=>{
 ...
 'use strict';
  ...
  const APIToken = 'p5TfeCUhpGriksNYZQoK1Jza4GcSZQddwZxJLobh'; // your API Token
  //const basicUserName = 'kazuki.konno@nipponhome.co.jp'; // basicAuth user name
  //const basicPassword = 'ub70waz3'; // basicAuth password
  
  const client = new KintoneRestAPIClient({
    baseUrl: 'https://as8o1urb84vz.cybozu.com',
    auth: {
      apiToken:'p5TfeCUhpGriksNYZQoK1Jza4GcSZQddwZxJLobh'
    }
  });
